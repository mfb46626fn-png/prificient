...
export default function SyncPage() {
    ...
    const startSyncEngine = async () => {
        try {
            ...
            // We don't auto-redirect immediately now, we show summary first.
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
                    ...
                    {status !== 'finishing' && status !== 'completed' && status !== 'failed_auth' && (
                        <div className="space-y-8">
                            ...
                            <div className="bg-black/50 rounded-lg p-4 font-mono text-xs h-32 overflow-hidden relative">
                                <div className="space-y-1">
                                    {logs.map((log, i) => (
                                        <div key={i} className={i === 0 ? 'text-green-400' : 'text-zinc-500'}>
