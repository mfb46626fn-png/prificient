...
export default function ProductDetailPage() {
    ...
    const formatCurrency = (val: number) => `${symbol}${convert(val)}`
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
                        <div>
                            ...
                            <div className="flex items-center gap-3 mt-3">
                                ...
                                {riskAnalysis && (
                                    <span className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider ${riskAnalysis.level === 'safe' ? 'bg-emerald-100 text-emerald-800' :
                                            ...
                                            {product.orders_list.map((order) => {
                                                ...
                                                return (
                                                    <tr key={order.id} className="hover:bg-gray-50/50 transition-colors group cursor-pointer" onClick={() => setSelectedOrder(order)}>
                                                        ...
                                                        <td className="px-6 py-4 text-right">
                                                            <span className={`px-2 py-1 rounded text-[10px] font-black ${margin > 20 ? 'bg-emerald-50 text-emerald-700' :
