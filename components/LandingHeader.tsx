    ...
    <>
      <header className={`sticky top-0 z-50 w-full border-b border-gray-100 backdrop-blur-md ${isMobileMenuOpen ? 'bg-white' : 'bg-white/90'}`}>
        <div className="relative mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          {/* MASAÜSTÜ MENÜ - Absolute Center */}
          <nav className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-8 text-sm font-bold text-gray-500">
